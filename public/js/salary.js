...
/******/ 	return __webpack_require__(__webpack_require__.s = 1756);
/******/ })
/************************************************************************/
/******/ ({
...
$(document).ready(function () {
    ...
    $('#confirm-save-fee-modal .save-table').on('click', function () {
        ...
        $('#confirm-save-fee-modal .form-group').each(function (formGroup) {
        ...
        axios.post('/dashboard/tariffs-plans/prices', {
            ...
            if (response && response.data) {
                for (var errorKey in response.data) {
    ...
    $('#confirm-save-missing-pn-fee-modal .save-table').on('click', function () {
        ...
        $('#confirm-save-missing-pn-fee-modal .form-group').each(function (formGroup) {
            $(formGroup).removeClass('has-error');
            $(formGroup).find('span.with-erorrs strong').html('');
        });
        $(this).prop('disabled', true);
    ...
    $('.grouped_plans_checkox').on('click', function () {
        var ids = $('.tab-pane.active .grouped_plans_checkox:checked').map(function (i, item) {
            return $(item).val();
        });
