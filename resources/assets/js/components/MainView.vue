<template>
  <div id="page-content-wrapper">
    ...
    >
      ...
      <div v-if="patient !== null" class="new-profile-wrapper">
              ...
              <div class="row">
                <div class="col-xs-8 col-md-9">
                  <h3 class="patient-name">
                    ...
                    <i
                      class="fa fa-refresh patient-age sync-patient"
                      title="Sync with OfficeAlly"
                      @click.prevent="showConfirmSyncPatient()"
                      v-if="
                        patient.patient_id != 11111111 &&
                        !patient.start_synchronization_time &&
                        !is_audit_mode
                      "
                    ></i>
                    <pageloader
                      add-classes="patient-sync"
                      v-if="patient.start_synchronization_time"
                      title="Synchronization"
                    />
                    <send-removal-request
                      :showButton="showRemovalRequestButton"
                      @patientChangedEvent="emitPatientChanged"
                      v-if="
                        !isUserAdmin && !is_read_only_mode && !is_audit_mode
                      "
                    ></send-removal-request>
                    <provider-cancel-removal-request
                      :showButton="showCancelRemovalRequestButton"
                      @patientChangedEvent="emitPatientChanged"
                      v-if="
                        !isUserAdmin && !is_read_only_mode && !is_audit_mode
                      "
                ...
                <div class="col-xs-4 col-md-3 text-right">
                  <div class="patient-status">
                    <span
                      v-if="patient.status"
                      :style="{ color: '#' + patient.status.hex_color }"
                    >
                      {{ patient.status.status }}
                    </span>
                    <el-tooltip
                      v-if="
                        patient.status_patient_info &&
                        patient.status_patient_info.date
                      "
                      class="item"
                      effect="dark"
                      placement="bottom"
            ...
            <div class="profile-flexbox">
              <div class="two-col">
                <div class="user-info-container">
                  <div class="profile-row">
                    <div class="profile-title">ID:</div>
                  ...
                  <div class="profile-row">
                    <div class="profile-title">Assigned to:</div>
                    <div class="profile-value">
                      <ul
                        class="patient-assigned-to-list"
                        v-if="patient.providers.length === 1"
                      >
                        <li v-for="(t, index) in patient.providers">
                          ...
                          <i
                            class="fa fa-plus fa-relationship-button"
                            v-if="isUserAdmin"
                            @click.prevent="
                      ...
                      <span v-else>
                        <i
                          class="fa fa-plus fa-relationship-button"
                          v-if="isUserAdmin"
                          @click.prevent="showAddPatientProviderRelationship()"
                        ></i>
                        <span v-else>-</span>
                      </span>
                    </div>
                  ...
                  <div
                    ...
                    v-if="patient.primary_insurance"
                  >
                    <div class="profile-title">Insurance:</div>
                    <div
                      class="profile-value"
                      v-html="getPatientInsurance(patient)"
                    ></div>
                  </div>
                  <div
                    class="profile-row"
                    style="align-items: center"
                    v-if="patient.insurance_plan && patient.insurance_plan.name"
                  >
                    <div class="profile-title text-right">Insurance plan:</div>
                    <div class="profile-value">
                  ...
                  <div
                    class="profile-row"
                    style="align-items: center"
                    v-if="showAuthorizationNumber"
                  >
                    <div class="profile-title text-right">
                      Authorization number:
                    </div>
                    <insurance-authorization-number
                      :patient="insuranceAuthorizationNumberData"
                    />
                  </div>
                  ...
                  <div class="profile-row" style="align-items: center">
                    ...
                    <div class="profile-value">
                      ...
                      <visit-frequency-changes-tooltip
                        v-if="
                          patient.visit_frequency_changes &&
                          patient.visit_frequency_changes.length
                        "
                  ...
                  <div class="profile-row" style="align-items: center">
                    <div class="profile-title text-right">Therapy Type:</div>
                    <div class="profile-value">
                  ...
                  <div class="profile-row">
                    <div class="profile-title">Sex:</div>
                    <div class="profile-value">
                      <template v-if="patient.sex === 'M'">Male</template>
                      <template v-else-if="patient.sex === 'F'"
                        >Female</template
                      >
                  ...
                  <div class="profile-row" v-if="!is_audit_mode">
                    ...
                    <div class="profile-value">
                      <a
                        ...
                        :class="{
                          'text-red':
                            patient.email_rejection_info &&
                            patient.email_rejection_info.email_rejected,
                        }"
                      >
                        {{ patient.email }}
                      </a>
                      ...
                      <template v-if="patient">
                        <i
                          v-if="isUserAdmin || !is_read_only_mode"
                          title="Update email"
                          style="margin-top: 2px; z-index: 10"
                          class="fa fa-pencil fa-relationship-button"
                        ...
                        <i
                          v-if="
                            ...
                            patient.email &&
                            patient.email_rejection_info &&
                            patient.email_rejection_info.email_can_be_restored
                          "
                  ...
                  <div class="profile-row" v-if="!is_audit_mode">
                    <div class="profile-title">Email Add:</div>
                    <div class="profile-value">
                      <a
                        ...
                        :class="{
                          'text-red':
                            patient.secondary_email_rejection_info &&
                            patient.secondary_email_rejection_info
                              .email_rejected,
                        }"
                      >
                      ...
                      <template v-if="patient">
                        ...
                        <i
                          ...
                          class="fa fa-repeat fa-relationship-button"
                          @click="
                            openEmailUnsubscribedDialog(patient.secondary_email)
                          "
                        ></i>
                      </template>
                    </div>
                  ...
                  <div
                    class="profile-row"
                    style="align-items: center"
                    v-if="!is_audit_mode && isUserAdmin"
                  >
                    <div class="profile-title text-right">
                      Patient agreements:
                    </div>
                  ...
                  <div class="profile-row" v-if="!is_audit_mode">
                    ...
                    <div
                      v-else-if="creditCards.length === 1"
                      class="profile-value"
                    >
                      <span
                        :class="{ 'text-red': isCardExpired(creditCards[0]) }"
                        >{{ getFormattedCardDetails(creditCards[0]) }}</span
                      >
                    </div>
                    <div v-else class="profile-value">
                      <a
                        style="cursor: pointer"
                        @click.prevent="showPatientCreditCardList"
                      >
                        View
                      </a>
                    </div>
                  ...
                  <div class="profile-row" v-if="patient.subscriber_id">
                    <div class="profile-title">Subscriber ID:</div>
                    <div class="profile-value">
                  ...
                  <template v-if="isUserAdmin">
                    <template v-if="patient.is_self_pay">
                      <div class="profile-row" v-if="!is_audit_mode">
                        <div class="profile-title">Self-Pay:</div>
                        <div class="profile-value">${{ patient.self_pay }}</div>
                      </div>
                    </template>

                    <template v-else>
                      <div class="profile-row" v-if="!is_audit_mode">
                        <div class="profile-title">Co-Pay:</div>
                        <div class="profile-value">
                          {{ formatted_patient_copay }}
                        </div>
                      </div>
                      <div class="profile-row" v-if="!is_audit_mode">
                        <div class="profile-title">Deductible:</div>
                        <div class="profile-value">
                          ${{ patient.deductible }}
                        </div>
                      </div>
                      <div class="profile-row" v-if="!is_audit_mode">
                        <div class="profile-title">Deductible Met:</div>
                        <div class="profile-value">
                      ...
                      <div class="profile-row" v-if="!is_audit_mode">
                        <div class="profile-title">Insurance Pay:</div>
                        <div class="profile-value">
                  ...
                  <template v-if="!is_audit_mode">
                    <div
                      class="profile-row"
                      v-if="isUserAdmin || isCollectPaymentAvailable"
                    >
                      <div class="profile-title">Balance:</div>
                      <div class="profile-value">
                        <span
                          :class="{
                            'text-red':
                              getPatientPreprocessedBalance(patient) < 0,
                          }"
                        >
                          {{
                            getFormattedMoney(
                    ...
                    <div
                      class="profile-row"
                      v-else-if="getPatientPreprocessedBalance(patient) < 0"
                    >
                      <div class="profile-title">Balance:</div>
                      <div class="profile-value">
                        <span :class="'text-red'"> Negative </span>
                      </div>
                    </div>
                  </template>

                  <div class="profile-row" v-if="!is_audit_mode">
                    <div class="profile-title">Payment:</div>
                    <div class="profile-value">
                ...
                <div class="center-col" v-show="!is_audit_mode">
                  <div class="profile-row">
                    <div class="profile-title">Progress Notes:</div>
                    <div class="profile-value">
                      {{ patientNoteCount }}
                  ...
                  <div class="profile-row no-wrap" v-if="isUserAdmin">
                    <div class="profile-title">Draft Progress Notes:</div>
                    <div class="profile-value">
                      {{ patientDraftNoteCount }}
                    </div>
                  </div>
                  <div class="profile-row no-wrap" v-if="isUserAdmin">
                    <div class="profile-title">Missing Progress Notes:</div>
                    <div class="profile-value">
                      {{ patientMissingNoteCount }}
                    </div>
                  </div>
                  <div class="profile-row" v-if="isUserAdmin">
                    <div class="profile-title">Initial Assessments:</div>
                    <div class="profile-value">
                      {{ patientInitialAssessmentCount }}
                    </div>
                  </div>
                  <div class="profile-row">
                    <div class="profile-title">Completed Sessions:</div>
                    <div class="profile-value">
                  ...
                  <div class="profile-row" v-if="isUserAdmin">
                    ...
                    <div class="profile-value d-flex align-items-center gap-1">
                      ...
                      >
                      <el-tooltip
                        v-if="patientCancelledAppointmentsCount"
                        class="item"
                        effect="dark"
                        placement="bottom"
                      >
                  ...
                  <div class="profile-row" v-if="isUserAdmin">
                    ...
                    <div class="profile-value d-flex align-items-center gap-1">
                      ...
                      <el-tooltip
                        v-if="completedAndVisitCreatedAppointmentCount"
                        class="item"
                        effect="dark"
                        placement="bottom"
                      >
                  ...
                  <div class="profile-row" v-if="isUserAdmin">
                    <div class="profile-title">Average Session Length:</div>
                    <div class="profile-value">
              ...
              <div class="buttons-container">
                ...
                <a
                  ...
                  role="button"
                  :href="`${office_ally_href}${patient.patient_id}`"
                  target="_blank"
                >
                  View in OfficeAlly
                </a>
                <a
                  v-if="patient.upheal_user_id"
                  class="btn btn-warning view-in-officeally-btn view-in-upheal-btn pull-right patient-info-block-btn"
                  role="button"
                  :href="`${upheal_href}${patient.upheal_user_id}`"
                  target="_blank"
                >
                  View in Upheal
                </a>
                <collect-payment-button
                  v-if="
                    patient &&
                    !isUserPatientRelationManager &&
                    (isUserAdmin || isCollectPaymentAvailable)
                  "
                  :patient="patient"
                ></collect-payment-button>
        ...
        <div class="chart-tabs">
          <div
            class="chart-tab"
            :class="{ active: tabs.timeline.active }"
            @click="changeTab('timeline')"
          >
            <div class="chart-tab-title">Chart</div>
          </div>

          <div
            class="chart-tab"
            :class="{ active: tabs.patientForms.active }"
            v-show="!is_audit_mode"
          ...
          <div
            class="chart-tab"
            :class="{ active: tabs.appointments.active }"
            v-show="!is_audit_mode"
          ...
          <div
            class="chart-tab"
            :class="{ active: tabs.visits.active }"
            @click="changeTab('visits')"
            v-show="!is_audit_mode"
          >
            <div class="chart-tab-title">Visits ({{ tabs.visits.count }})</div>
          </div>
          <div
            class="chart-tab"
          ...
          <div
            ...
            v-show="!is_audit_mode && isUserAdmin"
      ...
      <div
        class="note-loader-container"
        v-if="
          (isNoteLoading && tabs.timeline.active) ||
      ...
      />
      <notifications
        v-if="tabs.notifications.active && !statuses.notifications_loading"
      />
      <patient-forms-tab
      ...
      <div
        id="fine-upload-container"
        v-show="tabs.timeline.active && !isNoteLoading && !is_audit_mode"
      >
        <ul class="nav nav-pills nav-stacked col-xs-2">
          ...
          <li :class="{ active: is_read_only_mode }">
            <a data-toggle="tab" href="#comment" @click="initTributePlugin()"
              >Comment</a
            >
          </li>
        </ul>
        ...
        <div class="tab-content col-xs-10">
          ...
          <div
            id="comment"
            class="tab-pane fade"
            :class="{ 'in active': is_read_only_mode }"
          >
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <pageloader
              ...
              v-show="statuses.saving_document_type"
            ></pageloader>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      data-backdrop="static"
      data-keyboard="false"
      id="delete-patient-provider-modal"
      role="dialog"
      style="z-index: 9999"
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <h5 v-if="provider_to_delete">
              ...
              <b>{{ provider_to_delete.provider_name }}</b> from the
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-primary"
              @click.prevent="addPatientProviderRelationship()"
              :disabled="
                !available_providers ||
            ...
            <button
              type="button"
              class="btn btn-default"
              @click.prevent="closeAddPatientProviderModal()"
            >
              Cancel
            </button>
          </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <p>
              The document cannot be uploaded at this time. You must first
              complete the Initial Assessment Form through this system for all
              new patients. If you believe you see this message due to an error,
          ...
          <div class="modal-footer">
            <div class="dropdown inline-block">
              <button
                ...
                @click.prevent="
                  showDocument(electronicDocumentsTypes.cwr_initial_assessment)
                "
              >
    ...
    <div
      ...
      data-backdrop="static"
      data-keyboard="false"
      id="pls-add-initial-assessment-modal"
      role="dialog"
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <p>
              Progress Notes cannot be added at this time. You must first
              complete the Initial Assessment Form through this system for all
              new patients. If you believe you see this message due to an error,
              please contact your system administrator for further assistance
              at:
            ...
            <ol style="padding-left: 15px">
              <li>
                The Initial Assessment Form must be created and added through
                this system. It cannot be uploaded as an additional document. If
                you are not sure how to do this, please schedule a training
                session with our support team. Email requests to:
                <a href="mailto:support@cwr.care">support@cwr.care</a> (put
                "Training" in the subject)
              </li>
              <li>
                You do not need to file a Progress Note on the same date of
                service in addition to the Initial Assessment for new patients.
              </li>
              <li>
                You must make sure the Initial Assessment is filed on time, and
                if required, also sent to the insurance company via secure
                channel to ensure compliance in accordance with the instructions
                provided during training.
              </li>
              <li>
                You must verify the identity of each patient and collect all
                information required to provide services on behalf of the
                company (retain a copy of insurance card, photo ID, and other
                documents)
              </li>
              <li>
                You are responsible for collecting co-payments from patients on
                the date when services were provided and must fulfill any
                documentation filing requests from patients in accordance with
          ...
          <div class="modal-footer">
            <div class="dropdown inline-block">
              ...
              <ul class="dropdown-menu">
                <li
                  v-if="initial_assessment_forms"
                  v-for="item in initial_assessment_forms"
                >
                  <a href="" @click.prevent="showDocument(item.slug)">{{
                    item.title
                  }}</a>
                </li>
              </ul>
          ...
          <form class="form-horizontal" @submit.prevent>
              ...
              <div class="form-group" id="email-to">
                ...
                <div class="col-sm-10">
                  <select class="form-control" v-model="selected_email">
                    <option
                      v-for="item in document_default_emails"
                      :value="item.email"
                    >
                      {{ item.title }}
                    </option>
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                :disabled="
                  sending || errors.has('document-password document-email')
                "
              >
                Send
              </button>
          ...
          <form class="form-horizontal" @submit.prevent>
            <div class="modal-body">
              <div class="form-group" id="fax-to">
                ...
                <div class="col-sm-11">
                  <select class="form-control" v-model="selected_fax">
                    <option
                      v-for="item in document_default_faxes"
                      :value="item.fax"
                    >
                      {{ item.title }}
                    </option>
              ...
              <div v-else-if="selected_fax">
                <div class="form-group">
                  <label
                    class="col-xs-12"
                    :class="{ error: documentFax.length !== 10 }"
                    for="document-fax"
                    >Please enter fax number, digits only.</label
                  >
                  <div class="col-xs-12">
                    <the-mask
                      id="document-fax"
                      ...
                      v-model="documentFax"
                    ></the-mask>
                    <span v-show="documentFax.length !== 10" class="help error"
                      >Fax must have 10 digits</span
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                :disabled="
                  sending || (selected_fax == -1 && documentFax.length !== 10)
                "
              >
                Send
              </button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <h5
              v-if="doc_to_delete"
              v-text="getConfirmDeletionDocumentText"
            ></h5>
          </div>
          <div class="modal-footer">
            <span class="text-red validation-error-msg">{{
            ...
            <button
              type="button"
              class="btn btn-default"
              @click.prevent="closeConfirmDeleting()"
            >
              No
            </button>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              type="button"
              class="btn btn-default"
              @click.prevent="closeConfirmDeletingComment()"
            >
              No
            </button>
          </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p v-if="patient">
              This action will retrieve information associated with this patient
              record (such as appointments, visits, patient information, etc.)
              from Office Ally. Do you want to synchronize this patient's
              information now?
            </p>
          </div>
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-primary"
              @click.prevent="syncPatientWithOfficeAlly()"
            >
              Yes
            </button>
            <button type="button" class="btn btn-default" data-dismiss="modal">
    ...
    <div
      id="confirm-change-document-status"
      class="modal modal-vertical-center fade"
      data-backdrop="static"
      data-keyboard="false"
      role="dialog"
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <h5 v-if="doc_to_change_status">
              Are you sure you want to make document as Public/Private?
            </h5>
          </div>
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-danger"
              @click.prevent="confirmChangingDocumentStatus()"
            >
              Yes
            </button>
            <button
              type="button"
              class="btn btn-default"
              @click.prevent="cancelChangingDocumentStatus"
            >
              No
            </button>
          </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <h5>Are you sure you want to archive the patient?</h5>
          </div>
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-danger"
              @click.prevent="movePatientToArchive"
        ...
        <div class="modal-content" v-loading="statuses.changing_email">
            ...
            >
              <div class="col-md-6">
                <el-form-item label="Email" prop="patient_email">
                  <el-input
                    type="email"
                    v-model="emailFormData.patient_email"
                  ></el-input>
                </el-form-item>
              </div>
              ...
              <div class="col-md-6">
                <el-form-item label="Email Add" prop="patient_secondary_email">
                  <el-input
                    type="email"
                    v-model="emailFormData.patient_secondary_email"
          ...
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-primary"
              :disabled="statuses.changing_email"
              @click.prevent="changePatientEmails"
            >
              Save
            </button>
            <button
              ...
              class="btn btn-default"
              :disabled="statuses.changing_email"
              @click.prevent="closeModal('modal-change-email')"
            >
              Cancel
            </button>
          </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <h5>
              You have {{ draftProgressNotes.length }} unfinished progress
              notes. You may either edit them or create a new one.
            </h5>
            <table
              class="table table-draft-list"
              v-if="draftProgressNotes.length > 0"
            >
              <thead>
                <tr>
                  <th>Created at</th>
              ...
              <tbody>
                <tr
                  v-for="draftPN in draftProgressNotes"
                  :key="`pn-${draftPN.id}`"
                >
                  <td>{{ getFormattedDateTime(draftPN.created_at) }}</td>
                  <td>
                    {{
                      draftPN.date_of_service
                        ? getFormattedDateTime(draftPN.date_of_service)
                        : "-"
                    }}
                  </td>
                  <td class="text-right">
          ...
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-primary"
              @click.prevent="createBlankNoteFromModal"
            >
              Add Progress Note
            </button>
            <button
              type="button"
              class="btn btn-default"
              @click.prevent="closeModal('modal-draft-list')"
            >
              Close
            </button>
          </div>
    ...
    <cwr-initial-assessment
      v-if="
        this.$store.state.currentDocument ==
    ...
    <va-request-for-reauthorization
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.va_request_for_reauthorization
      "
    ></va-request-for-reauthorization>
    <kp-request-for-reauthorization-pc
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_request_for_reauthorization_pc
      "
    ></kp-request-for-reauthorization-pc>
    ...
    <kp-request-for-reauthorization-la
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_request_for_reauthorization_la
      "
    >
    </kp-request-for-reauthorization-la>
    ...
    <axminster-rfr
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.axminster_rfr
      "
    ></axminster-rfr>
    <facey-rfr
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.facey_rfr
      "
    ></facey-rfr>
    <kp-behavioral-health-pc
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_behavioral_health_pc
      "
    ></kp-behavioral-health-pc>
    <kp-medication-evaluation-referral
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_medication_evaluation_referral
      "
    ></kp-medication-evaluation-referral>
    <kp-bhios-wh
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_bhios_wh
      "
    ></kp-bhios-wh>
    <kp-medication-evaluation-referral-pc
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_medication_evaluation_referral_pc
      "
    ></kp-medication-evaluation-referral-pc>
    <kp-medication-evaluation-referral-la
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_medication_evaluation_referral_la
      "
    ></kp-medication-evaluation-referral-la>
    <kpep-couples-counseling-referral
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kpep_couples_counseling_referral
      "
    ></kpep-couples-counseling-referral>
    <kpep-group-referral
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kpep_group_referral
      "
    ></kpep-group-referral>
    <kpep-intensive-treatment-referral
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kpep_intensive_treatment_referral
      "
    ></kpep-intensive-treatment-referral>
    <kpep-medication-evaluation-referral
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kpep_medication_evaluation_referral
      "
    ></kpep-medication-evaluation-referral>
    <kp-ref-for-groups-la
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_referral_for_groups_los_angeles
      "
    ></kp-ref-for-groups-la>
    <kp-ref-to-hloc-la
      v-if="
        this.$store.state.currentDocument ==
        this.electronicDocumentsTypes.kp_hloc_los_angeles
      "
    ></kp-ref-to-hloc-la>
    ...
    <consent-info-modal
      v-if="isUserAdmin"
      :consent-info="patient && patient.last_document_consent_info"
    />

    <credit-cards-modal
      :cards="creditCards"
      :formatter="getFormattedCardDetails"
...
export default {
    ...
    return {
      ...
      emailFormRules: {
        ...
        patient_secondary_email: [
          {
            type: "email",
            message: " Invalid additional email address",
            trigger: ["change", "blur"],
          },
        ],
      },
      ...
      documentCommentErrorMessage:
        "Error connecting to server. Please try to post comment later.",
      selected_email: null,
      documentEmail: "",
      documentPassword: "",
      selected_fax: null,
  ...
  mixins: [PatientBalance, datetimeFormatted, UploadFileSize],
  computed: {
    isUserAdmin() {
    ...
    formatted_patient_copay() {
      if (this.patient.visit_copay) {
        ...
        if (co_pay > 0) {
          co_pay = "$" + co_pay;
          if (
            this.patient.insurance_plan &&
            !this.patient.insurance_plan.need_collect_copay_for_telehealth
          ) {
    ...
    patient_charge_for_cancellation() {
      return this.patient && this.patient.charge_for_cancellation_appointment
        ? parseFloat(this.patient.charge_for_cancellation_appointment)
        : 0;
    },

    formatted_patient_charge_for_cancellation() {
      return this.patient_charge_for_cancellation > 0
        ? `$${this.patient_charge_for_cancellation}`
        : "-";
    },

    formatted_payment_forbidden() {
      return this.patient && this.patient.is_payment_forbidden
        ? "Forbidden"
        : "Allowed";
    },
    ...
    getConfirmDeletionDocumentText() {
      ...
      if (this.doc_to_delete.model === "PatientNote") {
        ...
        text +=
          (this.doc_to_delete.original_document_name
            ? this.doc_to_delete.original_document_name
            : this.doc_to_delete.document_name) + " document?";
      }
      return text;
    },
    ...
    is_other_document_type() {
      if (
        ...
        this.document_type_id == this.other_type_id
      ) {
        return true;
      }
      return false;
    ...
    patientAddress() {
      if (
        ...
        return this.createPatientAddressText([
          this.patient.address,
          this.patient.city,
          this.patient.state,
          this.patient.zip,
    ...
    getAdditionalPhones() {
      return (phone_type) => {
        return this.patient.additional_phones.filter(
          (item) => item.phone_type === phone_type
        );
      };
    },
    provider() {
    ...
    patientCancelledAppointmentsCount() {
      return this.patientCancelledAppointments
        ? this.patientCancelledAppointments.length
        : 0;
    },
    ...
    insuranceAuthorizationNumberData() {
      ...
      return {
        insurance_requires_verification:
          this.patient.insurance_plan.is_verification_required,
        ...
        reauthorization_notification_visits_count:
          this.patient.insurance_plan.reauthorization_notification_visits_count,
        reauthorization_notification_days_count:
          this.patient.insurance_plan.reauthorization_notification_days_count,
      };
    },
    ...
    showAuthorizationNumber() {
      ...
      if (
        this.insuranceAuthorizationNumberData.insurance_requires_verification
      ) {
        return true;
      }

      return !!this.insuranceAuthorizationNumberData
    ...
    canChargeLateCancellationFee() {
      ...
      if (this.patient.cancelation_fee_info) {
        const properties = Object.values(
          this.patient.cancelation_fee_info.booking_cancellation_policy
        );
    ...
    percentageOfCanceledAppointments() {
      ...
      return Math.round(
        (this.patientCancelledAppointmentsCount /
          this.patientAppointmentCount) *
          100
      );
    },
    ...
    percentageOfGoogleMeetingAndRingCentralAppointments() {
      ...
      return Math.round(
        ((this.patientGoogleMeetingAppointmentCount +
          this.patientRingCentralAppointmentCount) /
          this.completedAndVisitCreatedAppointmentCount) *
          100
      );
    },
    ...
    completedAndVisitCreatedAppointmentCount() {
      return (
        this.patientAppointmentVisitCreatedCount +
        this.patientAppointmentCompletedCount
      );
    },
  },
    ...
    selected_email() {
      ...
      if (this.selected_email == -1) {
        ...
        for (let i in this.document_default_emails) {
          if (
            this.document_default_emails[i]["email"] === this.selected_email
          ) {
    ...
    has_document_without_type() {
      ...
      if (this.has_document_without_type) {
        window.onbeforeunload = function (event) {
          self.$store
            .dispatch("deleteDocument", { id: self.document_id })
            .then((response) => {
    ...
    patient() {
      ...
      if (this.patient.start_synchronization_time) {
        this.patientInterval = window.setInterval(() => {
          this.$store
            .dispatch("checkPatientIsSynchronized", this.patient.id)
            .then(({ data }) => {
              if (!data) {
                return;
              }
  ...
  methods: {
    ...
    onEmailRemovedFromRejectList() {
      ...
      this.$store
        .dispatch("getPatient", { patientId: this.$route.params.id })
        .catch(() => {
          //
        });
      this.$store
    ...
    syncPatientWithOfficeAlly() {
      ...
      this.$store
        .dispatch("syncPatientWithOfficeAlly", payload)
        .then((response) => {
    ...
    showAddPatientProviderRelationship() {
      this.$store
        .dispatch("getAvailableProvidersForPatient", this.patient.id)
        .then((response) => {
    ...
    addPatientProviderRelationship() {
      ...
      this.$store
        .dispatch("addPatientProviderRelationship", payload)
        .then(() => {
          const patientId = this.patient.id;
          this.$store
            .dispatch("getPatient", { patientId: patientId })
            .then(() => {
    ...
    deletePatientProviderRelationship() {
      ...
      this.$store
        .dispatch("deletePatientProviderRelationship", payload)
        .then(() => {
          const patientId = this.patient.id;
          this.$store
            .dispatch("getPatient", { patientId: patientId })
    ...
    loadPatientForms() {
      ...
      this.$store
        .dispatch("getPatientFormsForChart", { id: this.$route.params.id })
        .finally(() => {
    ...
    loadAppointments() {
      ...
      this.$store
        .dispatch("getPatientAppointments", this.$route.params.id)
        .then(() => {
    ...
    loadVisits() {
      ...
      this.$store
        .dispatch("getPatientVisitCreatedAppointments", this.$route.params.id)
        .then((response) => {
          if (this.visits) {
            this.tabs.visits.count = this.visits.length;
          }
    ...
    loadTransactions() {
      ...
      (this.isUserAdmin || this.isCollectPaymentAvailable) &&
        this.$store
          .dispatch("getPatientPreprocessedTransactions", this.$route.params.id)
          .then(() => {
    ...
    loadNotifications() {
      ...
      this.isUserAdmin &&
        this.$store
          .dispatch("getPatientNotifications", this.$route.params.id)
          .then(() => {
    ...
    saveDocumentType() {
      ...
      if (
        ...
        this.validation_message =
          this.$store.state.validation_messages.required;
        return false;
      }

      if (
        this.visit_created_count == 0 &&
        this.discharge_ids.indexOf(parseInt(this.document_type_id)) !== -1
      ) {
        $("#document_type_id").addClass("input-error");
        this.validation_message =
          "The patient does not have Visit Created appointments.";
        return false;
      }

      if (
        parseInt(this.document_type_id) === this.other_type_id &&
        this.other_document_type.trim() === ""
      ) {
      ...
      this.$store.dispatch("setDocumentType", data).then((response) => {
        ...
        if (response.status === 200) {
          ...
          this.validation_message =
            this.$store.state.validation_messages.try_again;
        }
      });
    },
    ...
    getProviderName(note) {
      ...
      if (providerName !== null && providerName !== undefined) {
        ...
        note.full_admin_name !== null &&
        note.full_admin_name !== undefined
      ) {
    ...
    storeDocumentComment(note, payload) {
      ...
      this.$store
        .dispatch("storeDocumentComment", requestData)
        .then((response) => {
          if (response.status === 201) {
            this.$store.dispatch("getProviderMessages");
    ...
    sendDocumentByEmail(id) {
      ...
      this.$store
        ...
        .then((response) => {
          ...
          if (response.status !== 200) {
            window.alert(
              "Email could not have been sent due to connection problems. Please try again later."
            );
          }
        })
        .catch((error) => {
    ...
    emitPatientChanged() {
      ...
      this.$store
        .dispatch("getActiveRemoveRequests", this.patient.id)
        .then((response) => {
    ...
    continueInit() {
      ...
      this.$store.dispatch("getPatient", { patientId: id }).then((response) => {
        ...
        this.is_init = true;
        this.tabs.appointments.count =
          data.counts.upcoming_appointments +
          "/" +
          data.counts.past_appointments;
        this.tabs.visits.count = data.counts.visits;
      });

      this.$store
        .dispatch("getPatientFormsCount", { patientId: id })
        .then((response) => {
          if (!response || response.status === 403 || response.status === 404) {
            return;
          }
          ...
          let data = response.data;
          this.is_init = true;
          this.tabs.patient_forms_count.count =
            data.signed_forms_count + "/" + data.submitted_forms_count;
        });

      (this.isUserAdmin || this.isCollectPaymentAvailable) &&
        this.$store
          .dispatch("getPatientPreprocessedTransactionsCount", {
            patientId: id,
          })
          .then((response) => {
            if (
            ...
            let data = response.data;
            this.is_init = true;
            this.tabs.patient_card_transactions.count =
              data.patient_transaction_count;
          });
      ...
      this.isUserAdmin &&
        this.$store
          ...
          .then((response) => {
            ...
            this.tabs.notifications.count =
              this.$store.state.patient_notifications_count;
          });

      this.$store
        .dispatch("getPatientNotesWithDocumentsPaginated", { id: id })
        .then(() => {
          if (this.scrollTo) {
            let self = this;
    ...
    isFileHasPreview(name) {
      ...
      let extensions = ["pdf", "png", "jpg", "jpeg", "gif"];
    ...
    getFileIcon(note) {
      ...
      let exists_icons = ["7z", "rar", "zip", "word", "excel", "pdf", "image"];
      let extension = this.getFileExt(name);
      switch (extension) {
        case "doc":
        case "docx":
      ...
      if (exists_icons.indexOf(extension) !== -1) {
        this.default_document_previews[note.aws_document_name] =
          "/images/file_type/" + extension + ".png";
      } else {
        this.default_document_previews[note.aws_document_name] =
          "/images/file_type/default.png";
      }
    },
    ...
    deleteComment() {
      if (this.comment_to_delete) {
        switch (this.comment_to_delete.model) {
          case "PatientComment":
            this.$store
              .dispatch("deleteComment", this.comment_to_delete.id)
              .then(() => {
                this.$store.dispatch("getPatientNotesWithDocumentsPaginated", {
                  id: this.patient.id,
                });
    ...
    deleteDoc() {
      if (this.doc_to_delete) {
        if (this.doc_to_delete.model === "PatientElectronicDocument") {
          const patientId = this.patient.id;
          this.$store
            .dispatch("deleteElectronicDocument", this.doc_to_delete.id)
            .then((response) => {
      ...
      if (!this.is_read_only_mode) {
        ...
        this.uploader = new qq.FineUploader({
            ...
            onComplete: function (id, fileName, response, xhr) {
              if (!self.patient.is_documents_uploading_allowed) {
                if (!response.success) {
                  ...
                  $(
                    "#pls-add-initial-assessment-before-upload-doc-modal"
                  ).modal("show");
                }
              } else {
          ...
          thumbnails: {
            placeholders: {
              waitingPath:
                "../plugins/fine-uploader/placeholders/waiting-generic.png",
    ...
    showEmailModal(note) {
      ...
      if (note.default_address && note.default_address.email) {
        for (let i in this.document_default_emails) {
          if (
            this.document_default_emails[i]["email"] ===
            note.default_address.email
          ) {
    ...
    showFaxModal(note) {
      this.sendingDocumentId = note.id;
      this.sendingDocumentModel = note.model;
      this.documentFax = note.default_address.fax
        ? note.default_address.fax
        : "";
    ...
    getDraftProgressNotes() {
      return this.$store
        .dispatch("getDraftProgressNote", { id: this.patient.id })
        .then((response) => {
    ...
    openNoteBlank(appointment_id) {
      this.statuses.loading_note_blank = true;
      this.$store.dispatch("getCurrentDateAndTime").then((response) => {
        ...
        // });
        this.$store
          .dispatch("getFirstAppointmentDateHasntNote", payloadStr)
          .then((responseDate) => {
            ...
            this.$store
              .dispatch("getPreviousNoteData", patient_id)
              .then((responseNote) => {
                note = {
                  ...
                  long_range_treatment_goal:
                    responseNote.data.data.long_range_treatment_goal,
                  shortterm_behavioral_objective:
                    responseNote.data.data.shortterm_behavioral_objective,
                  diagnoses: responseNote.data.data.diagnoses || [],
                  diagnoses_editable:
                    "diagnoses_editable" in responseDate
                      ? responseDate.diagnoses_editable
                      : true,
                };
                if (appointment_id) {
                  note["start_time"] = responseDate.start_time;
                  note["end_time"] = responseDate.end_time;
                  note["treatment_modality_id"] =
                    responseDate.treatment_modality_id;
                  note["date_of_service"] = this.getFormattedDate(
                    responseDate.date
                  );
                }
                this.statuses.loading_note_blank = false;
                this.$store.dispatch("refreshCurrentNote", note).then(() => {
                  this.openNoteDialog();
                  window.setTimeout(() => {
    ...
    createAssessmentForm(form) {
      this.$store
        .dispatch("createNewPatientAssessmentForm", {
    ...
    showDocument(documentId) {
      ...
      if (!this.canFillInitialAssessment(documentId)) {
        ...
        if (this.patient.tridiuum_patient_id) {
          tridiuumUrl +=
            "admin/patients/" + this.patient.tridiuum_patient_id + "/edit";
        }

        this.modal_info_msg =
          'Initial Assessment for this patient should be filled in the <a href="' +
          tridiuumUrl +
          '" target="_blank">Lucet</a>.';
        $("#modal-info").modal("show");
    ...
    canFillInitialAssessment(documentId) {
      ...
      return (
        !this.patient.tridiuum_patient_id ||
        !initialAssessmentTypes.includes(documentId)
      );
    },

    getElectronicDocument(documentUniqueId, documentId) {
      this.$store
        .dispatch("getElectronicDocument", {
        ...
        for (let submenuIndex in assessmentFormsTemplate.childs) {
          ...
          if (submenu1.slug) {
            if (submenu1.group_id == 19) {
              if (submenu1.ind == 1) {
                electronicDocumentsInfo["va-request-for-reauthorization"] =
                  submenu1;
                this.electronicDocumentsTypes.va_request_for_reauthorization =
                  submenu1.slug;
              }
              ...
              if (submenu1.ind == 4) {
                electronicDocumentsInfo["kpep-couples-counseling-referral"] =
                  submenu1;
                this.electronicDocumentsTypes.kpep_couples_counseling_referral =
                  submenu1.slug;
                ...
                electronicDocumentsInfo["kpep-intensive-treatment-referral"] =
                  submenu1;
                this.electronicDocumentsTypes.kpep_intensive_treatment_referral =
                  submenu1.slug;
              } else if (submenu1.ind == 7) {
                electronicDocumentsInfo["kpep-medication-evaluation-referral"] =
                  submenu1;
                this.electronicDocumentsTypes.kpep_medication_evaluation_referral =
                  submenu1.slug;
              }
              ...
              if (submenu1.ind == 1) {
                electronicDocumentsInfo["kp-medication-evaluation-referral"] =
                  submenu1;
                this.electronicDocumentsTypes.kp_medication_evaluation_referral =
                  submenu1.slug;
              } else if (submenu1.ind == 2) {
                electronicDocumentsInfo[
                  "kp-medication-evaluation-referral-pc"
                ] = submenu1;
                this.electronicDocumentsTypes.kp_medication_evaluation_referral_pc =
                  submenu1.slug;
    ...
    movePatientToArchive() {
      ...
      this.$store.dispatch("updatePatient", payload).then(() => {
        ...
        this.$store
          .dispatch("getPatient", { patientId: this.patient.id })
          .then(() => {
    ...
    changePatientEmails() {
      this.$refs.emailForm.validate((valid) => {
        ...
        updates.push(
          this.$store.dispatch(
            "updatePatientSecondEmail",
            secondaryEmailPayload
          )
        );
    ...
    doScrolling(element, duration) {
      ...
      let scrollingElement =
        window.isSafari || window.isIE || window.isIOS
    ...
    listenZipArchivesCreation(userId) {
      window.Echo.private(`zip-archive.${userId}`).listen(
        ".zip-archive.created",
        (data) => {
          ...
          this.$store
            .dispatch("downloadPatientZipDocuments", {
  ...
  mounted() {
    ...
    this.$store.dispatch("getAssessmentFormTemplates").then((response) => {
      ...
      this.electronicDocumentsInfo = this.getElectronicDocumentsInfo(
        this.assessmentFormsTemplates
      );
